<template>
  <div class="project-details">
    ...
    <div class="banner project-details__banner"></div>
    <div class="container">
      <section class="project-details__info">
        <h2 class="project-details__info-heading">{{ project.heading }}</h2>
        <p class="project-details__info-text">
          {{ project.text1 }}
        </p>
        <p class="project-details__info-text">
          {{ project.text2 }}
  ...
  <defs>
    <filter id="filter0_d_1418_52" x="0" y="0" width="172" height="172" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
